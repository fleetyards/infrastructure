...
- `https://github.com/fleetyards/infrastructure/issues/1234` → issue number `1234`

### 2. Fetch the issue

```bash
gh issue view <number> --repo fleetyards/infrastructure --json number,title,body,labels,milestone,assignees,type
```
